  ...
  Widget build(BuildContext context) {
    return IntlPhoneField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: buildOutlineInputBorder(color: ColorManager.borderColor),
        focusedBorder: buildOutlineInputBorder(color: ColorManager.borderColor),
        errorBorder: buildOutlineInputBorder(color: ColorManager.primaryColor),
